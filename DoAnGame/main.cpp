...
void LoadResources()
{
	...
	sprites->Add(20002, 353, 170, 370, 187, texMisc);
	sprites->Add(20003, 371, 170, 388, 187, texMisc);
	sprites->Add(20004, 389, 170, 406, 187, texMisc);
	...
	sprites->Add(40001, 6, 129, 22, 156, texEnemy); // Rùa đi
	sprites->Add(40002, 28, 129, 44, 156, texEnemy);

	sprites->Add(40003, 49, 138, 66, 156, texEnemy); // rùa nghẻo
	...
	ani = new CAnimation(300);		// rùa đi bộ
	ani->Add(40001);
	ani->Add(40002);
	animations->Add(801, ani);

	ani = new CAnimation(1000);		//Rùa ngủm củ tỏi
	ani->Add(40003);
	...
	for (int i = 0; i < 50; i++)
	{
		...
		brick->SetPosition(0 + i * 1600.0f, 150);
		objects.push_back(brick);

		brick = new Nen();
		brick->AddAnimation(603);
		brick->SetPosition(16 + i * 16.0f, 150);
		objects.push_back(brick);

		brick = new Nen();
		brick->AddAnimation(604);
		brick->SetPosition(816 , 150);
		objects.push_back(brick);
	}
	...
	{
		rua = new Rua();
		rua->AddAnimation(801);
		rua->AddAnimation(802);
		rua->SetPosition(350 + i * 60, 125);
		rua->SetState(RUA_STATE_WALKING);
		objects.push_back(rua);
	}
